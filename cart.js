...
function sendConfirmationEmails(name, email, phone, date, street, city, state, zip, other) {
  var orderLines = window._pendingOrderLines || '';
  var totalStr   = window._pendingTotalStr   || '';
  ...
  // ── Email 2: HTML confirmation to customer via Render backend ──
  var confirmationHtml = buildConfirmationEmail(
    name, email, phone, date, street, city, state, zip, other,
    orderLines, totalStr, (window.LOGO_SRC || '')
  );
...
async function handlePayment() {
  ...
  sendConfirmationEmails(name, email, phone, date, street, city, state, zip, other);
