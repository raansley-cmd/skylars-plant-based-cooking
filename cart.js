...
async function handlePayment() {
  ...
  try {
    // ── Send order notification email to Skylar via Web3Forms ──
    ...
    var logoSrc = (window.ITEM_IMAGES && Object.keys(window.ITEM_IMAGES).length)
      ? '' : '';  // logo handled inside buildConfirmationEmail
    ...
    var customerPayload = {
      access_key:  '4b24cde9-9ae0-4a5e-a4e4-4e4c070b20f8',
      subject:     "Your Order is Confirmed — Skylar's Plant Based Cooking",
